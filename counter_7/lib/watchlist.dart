import 'package:counter_7/detailfilm.dart';
...
class _dataWatchlistState extends State<dataWatchlist> {
  Future<List<Mywatchlist>> fetchToDo() async {
    var url = Uri.parse('https://tugas2project.herokuapp.com/mywatchlist/json/');
                            ...
                            child: ListTile(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            detailMovie(moviedetail:snapshot.data![index] )),
                                  );
                                }),
                          ));
                }
